# O Jogo do Gato Zé | Zé The Cat Game

## Sobre | About

O Jogo do Gato Zé é um jogo de plataforma genérico que foi desenvolvido para servir de modelo para o ensino básico de programação de jogos e uso das funcionalidades da plataforma Greenfoot que serão apresentados na série de vídeos do GreenLabs laboratório de Jogos do GreenfootBR. 
